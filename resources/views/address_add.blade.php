...
@section('content')
    <form action="{{route('address.create')}}" enctype="multipart/form-data" method="POST">
        @method('post')
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="postal_code" aria-describedby="pscodeHelp" name="postal_code">
